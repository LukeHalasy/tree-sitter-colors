...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [3] = {
    ...
    [sym_hex_color] = ACTIONS(13),
    [sym__other_text] = ACTIONS(13),
  },
};
...
extern const TSLanguage *tree_sitter_hex_colors(void) {
